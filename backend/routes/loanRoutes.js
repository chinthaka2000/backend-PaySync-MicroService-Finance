...
router.get('/',
  requirePermissions(PERMISSIONS.VIEW_OWN_LOANS, PERMISSIONS.VIEW_REGIONAL_LOANS, PERMISSIONS.VIEW_ALL_LOANS),
...
router.get('/agent/:agentId/pending',
  authorizeRoles('agent', 'regional_manager', 'moderate_admin', 'super_admin'),
...
router.put('/:loanId/status',
  requirePermissions(PERMISSIONS.APPROVE_LOANS, PERMISSIONS.UPDATE_REGIONAL_LOANS),
...
router.get('/regional-manager/:regionalManagerId',
...
router.get('/regional-manager/:regionalManagerId/stats',
  authorizeRoles('regional_manager', 'moderate_admin', 'super_admin'),
  loanController.getRegionalManagerStats
);

// Agreement management routes
router.post('/:loanId/generate-agreement',
